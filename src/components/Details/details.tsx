...
const Details = ({ setSelectedPage }: PageProps) => {
  return (
    <section id="thedetails" className="details-section">
          ...
          <div className="details-content">
            ...
            >
              ...
              <p className="details-detail">
                For guests wishing to stay overnight accommodation is available at Corick House Hotel & Spa. 
                Make sure to book early to avoid disappointment. We'd love for you to stay and celebrate with us!
              </p>
              ...
              <p className="details-detail">
                For those joining us in the evening, the real party kicks off from 8pm at Corick House Hotel.
                Come ready for music, dancing and a great night altogether - We'll save you a spot on the dance floor!
              </p>
